...
const addToWatchBtn = document.querySelector('.button-add-to-watch');
const addToQueueBtn = document.querySelector('.button-add-to-queue');
...
// listeners for add watched and queue films in fire base
addToWatchBtn.addEventListener('click', writeUserWatchedFilm);
addToQueueBtn.addEventListener('click', writeUserQueueFilm);
